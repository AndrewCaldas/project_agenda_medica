      ...
      <nav class="navbar navbar-fixed-top navbar-inverse navbar-transparente">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a href="index.html" class="navbar-brand" class="sombra" style="color: white;"><b>Agenda</b></span> Medica<span style="font-size: 10px"> Online</span></a>
          </div>
                  ...
                  <a href="#">
                    ...
                    <!-- <div class="colum-buttom"></div> -->
                      <div class="text-custom text">
                        <a href="#" onclick="status()" id="agenda" data-element="#agendar"> 
                          <div class="colum-buttom">Agendar</div>
                        </a>
                        <a href="verAgenda.html" class="" id="veragenda" data-element=#veragenda>
                          ...
                          <br><br>
                            <form>
                                ...
                                <div style="text-align:center;">
                                    <a href="#" type="submit" class="btn btn-custom btn-pad btn-toggle" data-element="#agendar">Agendar agora</a>
                                </div>

...
<html lang="pt-br">
  <head>
    ...
    <title>Agenda Médica Online - Trocar senha</title>
       ...
       <!-- Recuperador de senha -->
        <div class="capa">
          <div class="texto-left col-md-6 card-box">
           <h3 class="text">Recuperação de Senha</h3>
           <br>
              ...
              <form>
                <div class="form-group">
                  ...
                  <small id="Help" class="form-text text-muted">
                      <br>
                      <p>*Após clicar no botão Enviar, verifique o seu e-mail para a recuperação de sua senha, caso não localize, verificar
                      a sua área de spam.</p>
                      <br>
                  </small>

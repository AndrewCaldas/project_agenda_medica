...
<body>
	...
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="index.jsp" class="navbar-brand" style="color: white;" class="sombra"><b>Agenda</b></span>
	...
	<div class="container">
		...
		<div class="capa">
			<div class="col-sm-8 card-box">
				...
				<br> <br>
				<form action="./verAgenda.jsp" method="post">
					<!-- campo ID do registro -->
					<div hidden>
					<input type="text" id="id" class="form-control" value="<%=credenciado.getId()%>">
					</div>
					...
					<br> <%if (credenciado.getId() == 0) { %>
							<input href="verAgenda.jsp" type="submit" name="cmd" value="Cadastrar" class="btn btn-custom btn-pad "/>
						 <% credenciadoDAOImpl.adicionar(credenciado);
						 String a = String.parseStr(credenciado.getCel());
						 System.out.print(a);
	...
	<!--  <script type="text/javascript" >
		function criar(){
			<% //CredenciadoDAOImpl credenciadoDAOImpl = new CredenciadoDAOImpl();
			//credenciadoDAOImpl.adicionar(credenciado); %> 
			alert("credenciado: ", this.credenciado);
		}

    ...
    <div class="container">
        ...
        <div class="capa">
          <div class="col-sm-8 card-box">
           <h3 class="text"><b>Cadastramento Clínico</b></h3>
           <br><br>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                            ...
                            <small id="crmJHelp" class="form-text text-muted">Preenchimento do CRM, é obrigatorio!</small>
                          </div>
                    ...
                    <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-6">
                         ...
                         <!--  
                          ...
                          <small id="CNPJHelp" class="form-text text-muted">Preenchimento do CNPJ da clínica, é obrigatorio!</small> -->
                        </div>

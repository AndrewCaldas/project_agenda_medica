...
<html lang="pt-br">
  <head>
    ...
    <title>Agenda Médica Online - Registrar</title>
          ...
          <h3 class="text">Cadastre-se</h3>
                <form>
                    ...
                    <div class="form-group">
                      ...
                      <small id="endereçoHelp" class="form-text text-muted">Digite um e-mail válido, por favor.</small>
                    </div>

                    <div class="form-group">
                      <label for="senha">Senha</label>
                      <input type="password" class="form-control" id="senha">
                      <small id="senhaHelp" class="form-text text-muted">Digite uma senha de até 8 digitos, uma letra e um simbolo, por favor.</small>  
                    </div>
                    ...
                    <div class="checkbox">
                      <label for="check">
                      <input type="checkbox" id="check"> Aceito os <a href="#">termos de serviço.</a>
